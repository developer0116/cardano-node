...
instance ConvertRawHash blk
  ...
  forMachine _dtal (TraceChainSyncServerRead tip (AddBlock _hdr)) =
      mconcat  [ "kind" .= String "ChainSyncServerRead.AddBlock"
               , tipToObject tip
               ]
  forMachine _dtal (TraceChainSyncServerRead tip (RollBack _pt)) =
      mconcat  [ "kind" .= String "ChainSyncServerRead.RollBack"
               , tipToObject tip
               ]
  forMachine _dtal (TraceChainSyncServerReadBlocked tip (AddBlock _hdr)) =
      mconcat  [ "kind" .= String "ChainSyncServerReadBlocked.AddBlock"
               , tipToObject tip
               ]
  forMachine _dtal (TraceChainSyncServerReadBlocked tip (RollBack _pt)) =
      mconcat  [ "kind" .= String "ChainSyncServerReadBlocked.RollBack"
               , tipToObject tip
               ]
